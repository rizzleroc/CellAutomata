# cellauto · web8 — The Guided Colony

web8 is **web7** (the "Catalytic Silence" lab) with **living amoeba guides**
...
The engine and the museum-vitrine shell are web7, **byte-identical**; web8 only
...
```bash
python3 -m http.server -d docs   # then visit /web8/
```
