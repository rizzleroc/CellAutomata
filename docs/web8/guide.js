// web8 — the living amoeba GUIDE (V1 narration + V2 ask-to-change).
//
...
// pure intent parser and execute against window.WEB8 — a small whitelisted bridge
...
function execute(action) {
  ...
  switch (action.kind) {
    ...
    case 'stage':
      ...
      return; // the web8:stage event will narrate the new plate
  }
}
...
function mount() {
  ...
  window.addEventListener('web8:stage', (e) => {
  ...
  const st0 = window.WEB8 && window.WEB8.state();
