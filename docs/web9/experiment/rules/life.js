...
(function () {
  ...
  (function loadLifeAtlas() {
    try {
      fetch("../web8/assets/life/atlas.json").then(function (r) { return r.json(); })
  ...
  function make() {
    ...
    return {
      ...
      hiRes: true,
      // Slow real-time sim cadence (main.js reads this): the engine steps ~5×/s
      // so cells crawl and divide believably instead of racing.
      stepsPerSec: 5,
