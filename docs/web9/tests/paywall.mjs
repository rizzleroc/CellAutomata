...
//     and the on-site full-feed Studio (../studio/, nav + card).
...
assert((html.match(/href="\.\.\/studio\//g) || []).length >= 2, "landing must link to the on-site Studio (../studio/) in both the nav and an Experiences card");
