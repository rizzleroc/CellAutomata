...
export function labelSprite(title, subtitle = '') {
  ...
  g.strokeStyle = '#caa86a'; g.lineWidth = 6; g.strokeRect(18, 18, c.width - 36, c.height - 36);
  g.fillStyle = '#e8e2d2'; g.textAlign = 'center'; g.font = 'bold 56px Georgia, serif';
  g.fillText(title, c.width / 2, 150);
  if (subtitle) { g.fillStyle = '#9a9382'; g.font = '30px Georgia, serif'; g.fillText(subtitle, c.width / 2, 240); }
