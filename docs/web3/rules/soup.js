...
(function () {
  ...
  function make() {
    ...
    return {
      ...
      // P1-D2: named mixing regimes for the prebiotic soup.
      presets: [
        { label: "dilute pool",
          hint: "A thin, calm soup — few molecules, slow random walk, no current. Tracks stay distinct, like a still pond.",
          values: { count: 200, diffusion: 0.30, evaporation: 0.02, drift: 0.00 } },
        { label: "well-mixed",
          hint: "A dense, well-mixed soup — many molecules colliding under steady diffusion. The Oparin–Haldane baseline.",
          values: { count: 600, diffusion: 0.60, evaporation: 0.04, drift: 0.00 } },
        { label: "tidal current",
          hint: "A vigorous, fast-diffusing soup swept by a current — chemistry streams one way, like an ocean tide.",
          values: { count: 1000, diffusion: 1.20, evaporation: 0.06, drift: 0.20 } },
      ],
