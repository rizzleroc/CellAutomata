// ZEBRA — Turing's stripe. The reaction-diffusion stripe regime is the mechanism Turing (1952)
// proposed for animal coats; this reel renders it as a bold black-&-cream hide.
// Path stays in stripe/labyrinth territory so the bands stay crisp and organic (they bend & fork).
import fs from 'fs';
...
fs.closeSync(fd);
fs.writeFileSync('/tmp/zebra_meta.json',JSON.stringify({W,H,NF,SEG,WP,fk,names,pop}));
