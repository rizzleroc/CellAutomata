// CHEETAH — the predator's coat. The spot/mitosis regime is the dotted Turing morphogen;
// rendered as dark spots on a golden hide. Stays spot-dominant with gentle drift.
import fs from 'fs';
...
fs.closeSync(fd);
fs.writeFileSync('/tmp/cheetah_meta.json',JSON.stringify({W,H,NF,SEG,WP,fk,names,pop}));
